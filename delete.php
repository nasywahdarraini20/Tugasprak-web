   ...
   <div class="container col-md-8">
      <div class="row justify-content-center">
         <div class="col">
            ...
            <h5 class="mb-4"> Apakah anda yakin akan menghapus pesanan dengan Kode_Pesanan <?php echo "$rest->Kode_Pesanan"; ?> ? </h5>
         </div>
         <form method="POST">
            <div class="form-group mb-3" align="center">
               <button type="submit" name="submit" class="btn btn-danger bi bi-eraser"> Remove </button>
               <input type="hidden" value="<?php echo "$rest->Kode_Pesanan"; ?>" class="form-control" name="Kode_Pesanan">
